...
func main() {
	...
	// Step 4: Save to output.go
	err = os.WriteFile("output.go", []byte(builder.String()), 0644)
	if err != nil {
		fmt.Println("Failed to write output.go:", err)
		os.Exit(1)
	}

	fmt.Println("✅ Structs generated and saved to output.go")
}
